...
<html>
  <head>
    <meta charset="utf-8">
    <title>Official One Direction Store-All</title>
  ...
  <body>
    ...
    <div id="homePage">
     ...
     <div id="registration_nav">
        <ul>
          ...
          <?php require_once('Classes/AvoidErrors.php');
   ...
   ?>
    ...
    <nav class="main_subnavi">
     <div id="Navig_sub">
        <ul>
           <li><a href="StoreOneDirection.php" class="first_a">ALL</a></li>
    ...
    <div id="Nav">
        ...
        <?php echo '<form action="" method="post" enctype="multipart/form-data" name="form2">';?>
           ...
           <li><a href=""><?php echo '<button type="submit" name="checkout" value="">CHECKOUT</button>';?></a></li>  <!--have to edit-->         
        </ul>
        <?php echo '</form>';?>
        </div>
    </nav>
