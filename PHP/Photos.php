...
<html>
  <head>
    <meta charset="utf-8">
    <title>Photos</title>
    <link rel="stylesheet" href="../CSS/FormatPhotos.css">
  ...
  <body>
   ...
   ?>
    ...
    <div id="Nav">
        <ul>
           ...
           <li><a href="Photos.php" class="this">PHOTOS</a></li>
   ...
   <?php
     ...
     $photo_per_page=9;
	 $totalNumberOfRecords=$a->getTotalNumberOfPhotoAlbums();
	...
	$photoAlbumArray=$p->getPhotoAlbums($offset,$photo_per_page);	

	
	foreach($photoAlbumArray as $photoAlbum){
		$p=$photoAlbum;		
		$source="../Images/Photo Albums/".$p->getPhoto();
		echo '<div class="photo_section" id="photo_section">';
		echo '<a href="BBCMusicAwards.php?photoId='.$p->getAlbumId().'" class="hvr-grow"><img src="'.$source.'"></a>';
        echo '<div id="text">';
        echo '<a href="BBCMusicAwards.php?photoId='.$p->getAlbumId().'"><p>'.$p->getAlbumName().'</p></a>';
        echo '</div>';
		echo '</div>';
    }
	
	$_PHP_SELF="Photos.php";
    $realPageNo=$page+1;
