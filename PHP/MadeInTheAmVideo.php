    ...
    <title>
      <?php
		...
		if(isset($_SESSION["album"])){
		   ...
		   foreach($r2 as $album){
			   $r=$album;
			   echo $r->getTitle().' Videos';
		  }
	   }
     ?>
    </title>
    <link rel="stylesheet" href="../CSS/FormatMadeInTheAMVideo.css">
  </head>
  ...
  <body>
   ...
   ?>
    ...
    <?php
	   ...
	   $v=new Video();
	   $videoArray=$v->GetVideosAccordingToId($_SESSION["album"]);
	   ...
	   foreach($videoArray as $video){
		   ...
		   echo '<a href="'.$v->getUrl().'"><img class="image_play" src="../Images/play-icon.png"></a>';
		   echo '</div>';
	   }
	?>    
    
   <div id="forth_stripe"> 
      <a href="MadeInTheAmVideo.php">
